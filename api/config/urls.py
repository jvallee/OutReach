...
api_info = openapi.Info(
    title="Dover Onsite Coding Challenge Backend API",
    default_version="v1",
...
schema_view = get_schema_view(api_info, url="http://django", public=True, permission_classes=(permissions.AllowAny,))
